...
def makeGly(segID: int, CA, CO, geo: Geo) -> Residue:
...
def makeAla(segID: int, CA, CO, geo: AlaGeo) -> Residue:
...
def makeSer(segID: int, CA, CO, geo: SerGeo) -> Residue:
...
def makeCys(segID: int, CA, CO, geo: CysGeo) -> Residue:
...
def makeVal(segID: int, CA, CO, geo: ValGeo) -> Residue:
...
def makeIle(segID: int, CA, CO, geo: IleGeo) -> Residue:
...
def makeLeu(segID: int, CA, CO, geo: LeuGeo) -> Residue:
